...
public class Account {
    ...
    public Double withdraw(Double amount) throws SaqueExeption {
        validwithdraw(amount);
        return balance -= amount;
    }

    public void validwithdraw(Double amount) throws SaqueExeption {
        if (amount > getBalance()) {
            throw new SaqueExeption("Saldo insuficiente");
        }
        if (amount > getWithdrawLimit()) {
            throw new SaqueExeption("Limite insuficiente");
        }
